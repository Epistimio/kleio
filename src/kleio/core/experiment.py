...
"""
:mod:`kleio.core.worker.experiment` -- Description of an optimization attempt
=============================================================================
...
from kleio.core.cli.evc import fetch_branching_configuration
from kleio.core.evc.adapters import Adapter, BaseAdapter
from kleio.core.evc.conflicts import detect_conflicts
from kleio.core.io.database import Database, DuplicateKeyError, ReadOnlyDB
...
from kleio.core.utils.format_trials import trial_to_tuple
...
class Experiment(object):
    ...
    --------
    user : str
       System user currently owning this running process, the one who invoked **Kleiṓ**.
    datetime : `datetime.datetime`
       When was this particular configuration submitted to the database.
    kleio_version : str
       Version of **Kleiṓ** which suggested this experiment. `user`'s current
       **Kleiṓ** version.
    user_args : list of str
       Contains separate arguments to be passed when invoking `user_script`,
       possibly templated for **Kleiṓ**.
    ...
    user_commit_hash : str, optional
       Current `Experiment`'s commit hash for **Kleiṓ**'s invocation.

    """

    __slots__ = ('name', 'refers', 'metadata',
                 '_db', '_init_done', '_id', '_node', '_last_fetched')
    non_branching_attrs = ()
    ...
    def fetch_trials(self, query, selection=None):
        ...
        .. seealso::
            ...
            :meth:`kleio.core.io.database.AbstractDB.read` for more information about the
            arguments.
    ...
    def fetch_trials_tree(self, query, selection=None):
        ...
        .. seealso::
            ...
            :meth:`kleio.core.worker.Experiment.fetch_trials` for more information about the
            arguments.

            :class:`kleio.core.evc.experiment.ExperimentNode` for more information about the EVC
            tree.
    ...
    def connect_to_version_control_tree(self, node):
        ...
        .. seealso::
            ...
            :class:`kleio.core.evc.experiment.ExperimentNode`
    ...
    def _branch_config(self, conflicts, branching_configuration):
        ...
        if not experiment_brancher.is_resolved:
            # TODO: Meh... How to solve this...
            experiment_brancher.set_experiment_name()
...
class ExperimentView(object):
    ...
    .. seealso::
        ...
        :py:class:`kleio.core.worker.experiment.Experiment` for writable experiments.
    ...
    #                     Attributes
    valid_attributes = (["_id", "name", "refers", "metadata"] +
                        # Properties
        ...
        try:
            ...
            if "Configuration is different and generate a branching event" in str(e):
                raise RuntimeError(
                    ...
                    "Kleiṓ. Please repport to https://github.com/mila-udem/kleio/issues.") from e
