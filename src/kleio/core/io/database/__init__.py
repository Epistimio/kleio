# -*- coding: utf-8 -*-
"""
:mod:`kleio.core.io.database` -- Wrappers for database frameworks
=================================================================
...
Currently, implemented wrappers:
   ...
   - :class:`kleio.core.io.database.mongodb.MongoDB`

"""
from abc import abstractmethod, abstractproperty

from kleio.core.utils import (AbstractSingletonType, SingletonFactory)
...
class ReadOnlyDB(object):
    ...
    .. seealso::
        ...
        :py:class:`kleio.core.io.database.AbstractDB`
    """
