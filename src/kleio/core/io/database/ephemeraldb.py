# -*- coding: utf-8 -*-
"""
:mod:`kleio.core.io.database.ephemeraldb` -- Non permanent database
===================================================================

.. module:: database
   :platform: Unix
   :synopsis: Implement non permanent version of :class:`kleio.core.io.database.AbstractDB`

"""
from collections import defaultdict
import copy

from kleio.core.io.database import AbstractDB, DuplicateKeyError
...
class EphemeralDB(AbstractDB):
    ...
    .. seealso:: :class:`kleio.core.io.database.AbstractDB` for more on attributes.
...
class EphemeralCollection(object):
    ...
    .. seealso:: :class:`kleio.core.io.database.ephemeraldb.EphemeralDB` for database object.
