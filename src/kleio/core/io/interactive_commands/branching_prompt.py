...
# -*- coding: utf-8 -*-
"""
:mod:`kleio.core.io.interactive_commands.base_commands` -- CLI for conflict solving
===================================================================================
...
from kleio.core.evc import adapters, conflicts
from kleio.core.io.database import Database
from kleio.core.utils.diff import green, red
...
class BranchingPrompt(cmd.Cmd):
    ...
    intro = ('\n\n'
             'Welcome to Kleiṓ\'s experiment branching interactive conflicts resolver\n'
             '-----------------------------------------------------------------------\n\n'
    ...
    def _build_parsers(self):
        self.parser = argparse.ArgumentParser(prog="(kleio)", add_help=False)
    ...
    def do_shell(self, line):
        """Run a shell command. Ex: (kleio) ! pwd"""
