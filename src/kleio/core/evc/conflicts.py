...
"""
:mod:`kleio.core.evc.conflicts` -- Description and resolution of configuration conflicts
========================================================================================
...
from kleio.core.utils.format_trials import standard_param_name
...
class Conflicts(object):
    ...
    def get_remaining(self, types=(), dimension_name=None, callback=None):
        ...
        .. note::
            ...
            See :meth:`kleio.core.evc.conflict.Conflicts.get` for more information.
    ...
    def try_resolve(self, conflict, *args, **kwargs):
        ...
        Parameter
        ---------
        conflict: `kleio.ore.evc.conflicts.Conflict`
...
class Conflict(object, metaclass=ABCMeta):
    ...
    resolution: None or `kleio.core.evc.conflicts.Resolution`
    ...
    def get_marked_arguments(self, conflicts):
        ...
        Parameters
        ----------
        conflicts: `kleio.core.evc.conflicts.Conflicts`
    ...
    def try_resolve(self):
        ...
        Returns
        -------
        None or `kleio.core.evc.conflicts.Resolution`
...
class Resolution(object, metaclass=ABCMeta):
    ...
    Attributes
    ----------
    conflict: `kleio.core.evc.conflicts.Conflict`
        The conflict which is resolved by this resolution.
    new_conflicts: list of `kleio.core.evc.conflicts.Conflict`
...
class NewDimensionConflict(Conflict):
    ...
    Attributes
    ----------
    dimension: `kleio.algo.space.Dimension`
    ...
    .. seealso ::
        ...
        :class:`kleio.core.evc.conflicts.Conflict`
    ...
    class AddDimensionResolution(Resolution):
        ...
        .. seealso ::
            ...
            :class:`kleio.core.evc.conflicts.Resolution`
...
class MissingDimensionConflict(Conflict):
    ...
    def get_marked_arguments(self, conflicts):
        ...
        .. seealso::
            ...
            :meth:`kleio.core.evc.conflicts.Conflict.get_marked_arguments`
    ...
    def try_resolve(self, new_dimension_conflict=None, default_value=Dimension.NO_DEFAULT_VALUE):
        ...
        Parameter
        ---------
        new_dimension_conflict: None or `kleio.core.evc.conflicts.NewDimensionConflict`
    ...
    class RenameDimensionResolution(Resolution):
        ...
        Attributes
        ----------
        new_dimension_conflict: `kleio.core.evc.conflicts.NewDimensionConflict`
...
class CodeConflict(Conflict):
    ...
    def try_resolve(self, change_type=None):
        ...
        change_type: None or string
            One of the types defined in `kleio.core.evc.adapters.CodeChange.types`.

        Raises
        ------
        ValueError
            If change_type is not in `kleio.core.evc.adapters.CodeChange.types`.
    ...
    class CodeResolution(Resolution):
        ...
        def _validate(self, change_type):
            """Validate change_type is in `kleio.core.evc.adapters.CodeChange.types`"""
...
class CommandLineConflict(Conflict):
    ...
    def try_resolve(self, change_type=None):
        ...
        ---------
        change_type: None or string
            One of the types defined in `kleio.core.evc.adapters.CommandLineChange.types`.

        Raises
        ------
        ValueError
            If change_type is not in `kleio.core.evc.adapters.CommandLineChange.types`.
    ...
    class CommandLineResolution(Resolution):
        ...
        def _validate(self, change_type):
            """Validate change_type is in `kleio.core.evc.adapters.CommandLineChange.types`"""
...
class ScriptConfigConflict(Conflict):
    ...
    def try_resolve(self, change_type=None):
        ...
        ---------
        change_type: None or string
            One of the types defined in `kleio.core.evc.adapters.ScriptConfigChange.types`.

        Raises
        ------
        ValueError
            If change_type is not in `kleio.core.evc.adapters.ScriptConfigChange.types`.
    ...
    class ScriptConfigResolution(Resolution):
        ...
        conflict: `kleio.core.evc.conflicts.Conflict`
            The conflict which is resolved by this resolution.
        change_type: string
            One of the types defined in `kleio.core.evc.adapters.ScriptConfighange.types`.
        ...
        def _validate(self, change_type):
            """Validate change_type is in `kleio.core.evc.adapters.ScriptConfigChange.types`"""
