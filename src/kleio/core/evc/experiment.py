...
"""
:mod:`kleio.core.evc.experiment` -- Experiment node for EVC
===========================================================
...
class ExperimentNode(TreeNode):
    ...
    item: None or :class:`kleio.core.worker.experiment.Experiment`
...
def fetch_trials_tree(experiment_node, query, selection=None):
    ...
    .. seealso::
        ...
        :meth:`kleio.core.evc.experiment.ExperimentNode.fetch_trials`
