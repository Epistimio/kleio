# -*- coding: utf-8 -*-
"""
:mod:`kleio.core.evc.tree` -- Tree data structure for the experiment version control system
===========================================================================================
...
class PreOrderTraversal(object):
    ...
    Attributes
    ----------
    stack: list of `kleio.core.evc.tree.TreeNode`
...
class DepthFirstTraversal(object):
    ...
    stack: list of `kleio.core.evc.tree.TreeNode`
        Nodes logged during iteration
    seen: set of `kleio.core.evc.tree.TreeNode`
...
class TreeNode(object):
    ...
    .. seealso::
        `kleio.core.evc.tree.PreOrderTraversal`
        `kleio.core.evc.tree.DepthFirstTraversal`

    Attributes
    ----------
    item: object
        Can be anything
    parent: None or instance of `kleio.core.evc.tree.TreeNode`
        The parent of the current node, None if the current node is the root.
    children: None or list of instances of `kleio.core.evc.tree.TreeNode`
        The children of the curent node.
    root: instance of `kleio.core.evc.tree.TreeNode`
    ...
    def __init__(self, item, parent=None, children=tuple()):
        ...
        .. seealso::
            :class:`kleio.core.evc.tree.TreeNode` for information about the attributes
        """
        self._item = item
        self._parent = None
        self._children = []
    ...
    def add_children(self, *nodes):
        ...
        .. seealso::
            `kleio.core.evc.tree.TreeNode.drop_children`
        """
        for child in nodes:
    ...
    def map(self, function, node):
        ...
        node: None, `kleio.core.evc.TreeNode` or list
            Can be either
