...
"""
:mod:`kleio.core.evc.adapters` -- Adapters to connect experiments within the EVC system
=======================================================================================
...
class BaseAdapter(object, metaclass=ABCMeta):
    ...
    def forward(self, trials):
        ...
        Parameters
        ----------
        trials: list of :class:`kleio.core.worker.trial.Trial`
            List of :class:`kleio.core.worker.trial.Trial` coming from the parent experiment
    ...
    def backward(self, trials):
        ...
        ----------
        trials: list of :class:`kleio.core.worker.trial.Trial`
            List of :class:`kleio.core.worker.trial.Trial` coming from the child experiment
    ...
    def to_dict(self):
        ...
        .. seealso::
            ...
            :meth:`kleio.core.evc.adapters.BaseAdapter.configuration`
        """
        pass
...
class CompositeAdapter(BaseAdapter):
    ...
    Attributes
    ----------
    adapters: instances of `kleio.core.evc.adapters.BaseAdapter`
    ...
    def forward(self, trials):
        ...
        .. seealso::
            ...
            :meth:`kleio.core.evc.BaseAdapter.forward`
        """
    ...
    def backward(self, trials):
        ...
        .. seealso::
            ...
            :meth:`kleio.core.evc.BaseAdapter.backward`
        """
    ...
    def to_dict(self):
        ...
        .. seealso::
            ...
            :meth:`kleio.core.evc.adapters.BaseAdapter.to_dict`
            :meth:`kleio.core.evc.adapters.CompositeAdapter.configuration`
        """
        pass
    ...
    def configuration(self):
        ...
        .. seealso::
            ...
            :meth:`kleio.core.evc.BaseAdapter.configuration`
        """
...
class DimensionAddition(BaseAdapter):
    ...
    Attributes
    ----------
    param: instances of `kleio.core.worker.trial.Trial.Param`
    ...
    def __init__(self, param):
        ...
        Parameters
        ----------
        param: instance of `kleio.core.worker.trial.Trial.Param` or `dict`
            A parameter object which defines the name and default value of the name dimension.
...
class DimensionDeletion(BaseAdapter):
    ...
    .. note::
        ...
        This adapter is the opposite of `kleio.core.evc.adapters.DimensionAddition`.
    ...
    Attributes
    ----------
    dimension_addition_adapter: instance of `kleio.core.evc.adapters.DimensionAddition`
    ...
    def forward(self, trials):
        ...
        .. seealso::
            ...
            :meth:`kleio.core.evc.DimensionAddition.backward`
            :meth:`kleio.core.evc.BaseAdapter.forward`
        """
    ...
    def backward(self, trials):
        ...
        .. seealso::
            ...
            :meth:`kleio.core.evc.DimensionAddition.forward`
            :meth:`kleio.core.evc.BaseAdapter.backward`
        """
...
class DimensionPriorChange(BaseAdapter):
    ...
    old_prior: `str`
        string definition as parsable by `kleio.core.io.space_builder`.
    new_prior: `str`
        string definition as parsable by `kleio.core.io.space_builder`.
    old_dimension: instance of `kleio.algo.space.Dimension`
        The dimension of the parent experiment
    new_dimension: instance of `kleio.algo.space.Dimension`
...
class Adapter(BaseAdapter, metaclass=Factory):
    ...
    .. seealso:: `kleio.core.utils.Factory` metaclass and `BaseAlgorithm` interface.
    """
    ...
    def build(cls, adapter_dicts):
        ...
        Returns
        -------
        `kleio.core.evc.adapters.CompositeAdapter`
