# -*- coding: utf-8 -*-
"""
:mod:`kleio.core.cli.evc` -- Function utilities for evc in cli
==============================================================

.. module:: evc
   :platform: Unix
   :synopsis: Kleiṓ helper functions to parse command-line options for branching resolution
...
def _add_code_argument(parser, resolution_class):
    parser.add_argument(
        ...
        default=adapters.CodeChange.BREAK,
...
def _add_cli_argument(parser, resolution_class):
    parser.add_argument(
        resolution_class.ARGUMENT,
        default=adapters.CommandLineChange.BREAK,
...
def _add_config_argument(parser, resolution_class):
    parser.add_argument(
        resolution_class.ARGUMENT,
        default=adapters.ScriptConfigChange.BREAK,
